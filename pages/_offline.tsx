...
const CustomOffline = () => {
  ...
  100% { transform: translateX(1000px) translateY(0); }
      ...
      <div className="main">
        <div>
          <svg viewBox="0 0 1000 355" xmlns="http://www.w3.org/2000/svg">
            <g id="ocean">
              <path className="st0" d="M0 0h1000v203.1H0z" id="sky" />
              <linearGradient
              ...
              <path d="M0 200.7h1000V354H0z" fill="url(#water_1_)" id="water" />
              <path className="st0" d="M0 273.4h1000V354H0z" id="land" />
              <g id="bumps">
            ...
            <g id="train">
              <path d="M344.5 248.5h507.2v37.8H344.5z" fill="#b3dcdf" />
              <g id="wheels">
              ...
              <path className="st7" d="M383.2 285.6h88.1" id="bracefront" />
              <path className="st7" d="M733.2 285.6h88.1" id="braceback" />
              <g id="car-layers">
                <path
                  className="st8"
                ...
                <g id="ladders">
                  <g id="ladder-f">
                    <path className="st8" d="M433.8 258.4h17.8v34.8h-17.8z" id="front-ladder" />
                    <path className="st9" d="M433.8 281.1h17.7" id="fb-rung" />
                    <path className="st9" d="M433.8 268.6h17.7" id="ft-rung" />
                  </g>
                  <g id="ladder-b">
                    <path className="st8" d="M851.8 257.8h17.8v34.8h-17.8z" id="ladder-back" />
                    <path className="st9" d="M851.8 268.6h17.7" id="bt-rung" />
                    <path className="st9" d="M851.8 281.1h17.7" id="bb-rung" />
                  </g>
                </g>
                <path
                  className="st8"
